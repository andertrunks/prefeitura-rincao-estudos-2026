...
const agentSpecific = makeTopics('aa', ['agente'], 'especificos', 35, 'Anexo II - Conhecimentos específicos / Agente Administrativo', [
  ...
  ['manuais', 'Manuais de redação oficial', 'Revisar de forma integrada o Manual de Redação e de Atos Oficiais e o Manual de Redação da Presidência da República.', ['Diferencie a fonte institucional de cada manual.', 'Observe padrões de redação, estrutura e competência.', 'Considere a atualização normativa indicada na aula.']],
...
const monitorSpecific = makeTopics('me', ['monitor'], 'especificos', 39, 'Anexo II - Conhecimentos específicos / Monitor de Educação', [
  ...
  ['relacoes', 'Relações humanas no trabalho', 'Atuar com respeito, cooperação, limites profissionais e compromisso com a convivência no ambiente escolar.', ['Evite exposição da criança.', 'Comunique-se com a equipe.', 'Não discrimine.']],
  ...
  ['regimento-escolar', 'Regimento escolar', 'Compreender a função, a estrutura e a aplicação cotidiana do regimento da unidade escolar.', ['Conheça direitos, deveres e competências.', 'Aplique regras com finalidade educativa.', 'Encaminhe situações conforme o procedimento institucional.']],
  ['etica-cidadania', 'Ética e cidadania no trabalho', 'Relacionar responsabilidade, respeito, interesse público, direitos e deveres à atuação do Monitor de Educação.', ['Preserve a dignidade de todos.', 'Evite favorecimento e discriminação.', 'Atue com responsabilidade e cooperação.']],
